    ...
    <>
      ...
      <div className="rounded-2xl border border-outline-variant/30 bg-surface-container-lowest p-5 shadow-ambient md:p-6">
        <form className="flex flex-col gap-6" onSubmit={handleSave}>
          <section>
            <h3 className="mb-4 text-xs font-semibold uppercase tracking-wider text-on-surface-variant">Store Details</h3>
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="flex flex-col gap-2">
                <span className="text-sm font-medium text-on-surface">Store Icon Image</span>
                <div
